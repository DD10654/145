...
label_pin = Labal(root)
label_adderess = Label(root)
...
def update():
    ...
    dob = "15th Nov 2010"
    pin = 123456
    adderss = "this is my adderess"
    vehicle = "every single vehicle in the world"
    label_id["text"] = id
    label_name["text"] = name
    label_dob["text"] = dob
    label_pin["text"] = pin
    label_address["text"] = adderess
    label_vehicle["text"] = vehicle
    
# Create a button
button1 = Button(root, text = "Show My Driving Card", command=update())
